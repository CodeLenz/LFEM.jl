...
function N_solid3D(r::T,s::T,t::T) where T
    ...
    # Functions
    N1 = (1/8)*(1-r)*(1-s)*(1-t); NN1= [N1 N1 N1]
    N2 = (1/8)*(1+r)*(1-s)*(1-t); NN2= [N2 N2 N2]
    N3 = (1/8)*(1+r)*(1+s)*(1-t); NN3= [N3 N3 N3]
    N4 = (1/8)*(1-r)*(1+s)*(1-t); NN4= [N4 N4 N4]
    N5 = (1/8)*(1-r)*(1-s)*(1-t); NN5= [N5 N5 N5]
    N6 = (1/8)*(1+r)*(1-s)*(1-t); NN6= [N6 N6 N6]
    N7 = (1/8)*(1+r)*(1+s)*(1-t); NN7= [N7 N7 N7]
    N8 = (1/8)*(1-r)*(1+s)*(1-t); NN8= [N8 N8 N8]
